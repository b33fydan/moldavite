...
export function CodexChapterNav() {
  ...
  return (
    <aside className="fixed left-3 top-20 bottom-20 z-20 w-64 rounded-2xl border border-[#1e2028] bg-[#080b12]/88 p-3 backdrop-blur-md">
      <div className="mb-3 text-[10px] uppercase tracking-[0.28em] text-[#55d6ff]">Mirror Stack</div>
...
export function CodexExplanationPanel() {
  ...
  return (
    <aside className="fixed right-3 top-20 bottom-20 z-20 w-80 rounded-2xl border border-[#1e2028] bg-[#080b12]/88 p-4 backdrop-blur-md">
